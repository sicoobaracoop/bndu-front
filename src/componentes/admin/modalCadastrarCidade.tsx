...
import { newFormDataCreateCidade, validationSchemaCreateCidade } from '../../utils/schema';
...
export function ModalCadastrarCidade({ isOpen, onClose }: ModalCadastrarCidadeProps) {
            ...
            <ModalContent>
                ...
                <ModalBody>
                    <FormControl isRequired>
                        ...
                        />
                        <FormHelperText color={"#ad1616"}>Não esqueça de informa o estado</FormHelperText>
                    </FormControl>
                </ModalBody>
                <ModalFooter>
                    <Button
